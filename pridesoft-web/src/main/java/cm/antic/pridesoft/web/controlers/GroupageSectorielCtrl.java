...
@RequestMapping("/groupagesectoriel")
public class GroupageSectorielCtrl implements Serializable{
	@Autowired
	...
	public String getDefaultGroupes (Model model, @SessionAttribute("localUrl") String localUrl) {
		ResponseEntity<ProjetSecteurActiviteDTO[]> response = rest.getForEntity(localUrl+"/ws/projettic/data/groupagesectoriel/periode/{dateDebut}/{dateFin}", 
				ProjetSecteurActiviteDTO[].class, dateDebut.format(formatter), dateFin.format(formatter)) ;
		List<ProjetSecteurActiviteDTO> listeGroupes = Arrays.asList(response.getBody());
	    ...
	    return "projettic/groupagesectoriel" ; 
	}
	...
	public @ResponseBody  ResponseEntity<Resource> getBarChart (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/barchart/groupagesectoriel/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
	...
	public @ResponseBody  ResponseEntity<Resource> getBarChart2 (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/barchart/groupagesectoriel2/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
	...
	public @ResponseBody  ResponseEntity<Resource> getPieChart (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/piechart/groupagesectoriel/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
	...
	public @ResponseBody  ResponseEntity<Resource> getPieChart2 (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/piechart/groupagesectoriel2/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
