...
@RequestMapping("/groupageannuel")
public class GroupageAnnuelCtrl implements Serializable{
	@Autowired
	...
	public String getDefaultGroupes (Model model, @SessionAttribute("localUrl") String localUrl) {
		ResponseEntity<ProjetAnnuelDTO[]> response = rest.getForEntity(localUrl+"/ws/projettic/data/groupageannuel/periode/{dateDebut}/{dateFin}", 
				ProjetAnnuelDTO[].class, dateDebut.format(formatter), dateFin.format(formatter)) ;
		List<ProjetAnnuelDTO> listeGroupes = Arrays.asList(response.getBody());
	    ...
	    return "projettic/groupageannuel" ; 
	}
	...
	public @ResponseBody  ResponseEntity<Resource> getBarChart (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/barchart/groupageannuel/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
	...
	public @ResponseBody  ResponseEntity<Resource> getBarChart2 (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/barchart/groupageannuel2/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
	...
	public @ResponseBody  ResponseEntity<Resource> getPieChart (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/piechart/groupageannuel/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
	...
	public @ResponseBody  ResponseEntity<Resource> getPieChart2 (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/piechart/groupageannuel2/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
