...
@RequestMapping("/groupageparmo")
public class GroupageParMaitreOuvrageCtrl implements Serializable{
	@Autowired
	...
	public String getDefaultGroupes (Model model, @SessionAttribute("localUrl") String localUrl) {
		ResponseEntity<ProjetMaitreOuvrageDTO[]> response = rest.getForEntity(localUrl+"/ws/projettic/data/groupageparmo/periode/{dateDebut}/{dateFin}", 
				ProjetMaitreOuvrageDTO[].class, dateDebut.format(formatter), dateFin.format(formatter)) ;
		List<ProjetMaitreOuvrageDTO> listeGroupes = Arrays.asList(response.getBody());
	    ...
	    return "projettic/groupageparmo" ; 
	}
	...
	public @ResponseBody  ResponseEntity<Resource> getBarChart (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/barchart/groupageparmo/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
	...
	public @ResponseBody  ResponseEntity<Resource> getBarChart2 (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/barchart/groupageparmo2/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
	...
	public @ResponseBody  ResponseEntity<Resource> getPieChart (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/piechart/groupageparmo/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
	...
	public @ResponseBody  ResponseEntity<Resource> getPieChart2 (@SessionAttribute("localUrl") String localUrl) {
		...
		ResponseEntity<byte[]> response = rest.getForEntity(localUrl+"/ws/projettic/piechart/groupageparmo2/periode/{dateDebut}/{dateFin}/{largeur}/{hauteur}", 
				byte[].class, dateDebut.format(formatter), dateFin.format(formatter), 600, 400) ;
